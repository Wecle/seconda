...
import { createStructuredInterviewAgentModelPort } from "@/lib/interview/agent/providers/model-port";

import { runInterviewAgent } from "@/lib/interview/agent/runtime/agent-runtime";
import { createInterviewToolRegistry } from "@/lib/interview/agent/tools/registry";
import type { AgentRunExecutor } from "@/lib/interview/agent/application/ports";
import {
  indexResumeEvidence,
  loadResumeEvidence,
} from "@/lib/interview/agent/domain/resume-evidence";
import { loadAgentContext } from "@/lib/interview/agent/context/assembler";
import { createProductionCompletionDependencies } from "@/lib/interview/completion/composition";
import { effectiveContextBudget } from "@/lib/interview/agent/context/budget";
import { compactInterviewContextIfNeeded } from "@/lib/interview/agent/context/persisted-compaction";
