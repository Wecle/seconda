    ...
    const [score] = await transaction
      ...
      .set({
        ...
        feedbackJson: {
          ...
          ...(input.evaluation.rootCause ? { rootCause: input.evaluation.rootCause } : {}),
          ...(input.evaluation.interviewerReaction ? { interviewerReaction: input.evaluation.interviewerReaction } : {}),
          ...(input.evaluation.rewriteExample ? { rewriteExample: input.evaluation.rewriteExample } : {}),
        },
        status: "scored",
        claimToken: null,
        claimExpiresAt: null,
