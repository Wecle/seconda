...
[4] Prepared round 2 target question with reasoning hint`,
  ...
  interview: {
    ...
    jobDescriptionOptional: "Target Job Description (Optional)",
    useExistingJd: "Select existing JD",
    noSavedJds: "No saved JDs",
    addNewJd: "Add New JD",
    pasteJdTab: "Paste Text",
    uploadJdTab: "Upload Document (PDF/Word)",
    jdTextInputPlaceholder: "Paste the job description here...",
    dropJdFile: "Drag or click to upload JD file (.pdf, .docx)",
    parsingJd: "Decoding job profile with AI...",
    parseJdFailed: "Failed to decode JD, please retry",
    parseAndBind: "Parse and Bind",
    clearJd: "Clear JD",
    targetJdBadge: "Target JD",
    changeJd: "Change",
    mustHaveSkillsTitle: "Must-Have Requirements",
    niceToHaveSkillsTitle: "Nice-to-Have Requirements",
    jdFitTitle: "JD Fit & Gap Analysis",
    jdFitSubtitle: "Alignment and gap analysis against target job description requirements",
    fitSummaryTitle: "Fit Summary",
    competenciesAssessed: "{count} competencies assessed",
    selectedFilePrefix: "Selected file: ",
    loadingJdList: "Loading saved JDs...",
    jdFormatError: "Only .pdf and .docx files are supported",
    jdFileSizeError: "File size exceeds 1MB limit",
    jdTextRequired: "Please paste the job description text",
    jdTextTooLong: "Job description text must be 8000 characters or less",
    jdFileRequired: "Please select a JD file to upload",
    jdDecodedSuccess: "Job description decoded successfully",
    copyQuestion: "Copy question",
    copiedToClipboard: "Copied to clipboard",
    skillsAssessmentTitle: "Skills Assessment",
    reverseQuestionsTitle: "Recommended Reverse Questions for Interviewer",
    criticalGapsTitle: "Critical Capability Gaps",
    fitRatings: {
