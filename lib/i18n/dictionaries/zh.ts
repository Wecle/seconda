...
[4] 生成第二轮主问题并附带思考提示`,
  ...
  interview: {
    ...
    jobDescriptionOptional: "目标岗位 JD（选填）",
    useExistingJd: "选用已有岗位 JD",
    noSavedJds: "暂无已保存的岗位 JD",
    addNewJd: "添加新岗位 JD",
    pasteJdTab: "粘贴文本",
    uploadJdTab: "上传文档 (PDF/Word)",
    jdTextInputPlaceholder: "在此粘贴目标岗位的 JD 描述（包括职责要求、技术栈等）...",
    dropJdFile: "拖拽或点击上传岗位 JD（支持 .pdf, .docx）",
    parsingJd: "正在通过 AI 解码岗位画像...",
    parseJdFailed: "解析岗位 JD 失败，请重试",
    parseAndBind: "解析并对标",
    clearJd: "取消对标",
    targetJdBadge: "对标岗位 JD",
    changeJd: "更换",
    mustHaveSkillsTitle: "核心必备要求",
    niceToHaveSkillsTitle: "加分项要求",
    jdFitTitle: "岗位契合度与差距诊断",
    jdFitSubtitle: "对标目标岗位画像的胜任力契合度与能力差距诊断",
    fitSummaryTitle: "契合度研判综述",
    competenciesAssessed: "共评估 {count} 项胜任能力",
    selectedFilePrefix: "已选择文件：",
    loadingJdList: "正在获取岗位 JD...",
    jdFormatError: "仅支持上传 .pdf 与 .docx 格式的岗位文档",
    jdFileSizeError: "文档大小不能超过 1MB",
    jdTextRequired: "请输入岗位 JD 文本描述",
    jdTextTooLong: "岗位描述不能超过 8000 字符",
    jdFileRequired: "请先选择需要上传的岗位文档",
    jdDecodedSuccess: "岗位 JD 画像解码成功并已对标",
    copyQuestion: "复制问题",
    copiedToClipboard: "已复制到剪贴板",
    skillsAssessmentTitle: "核心技能胜任力盘点",
    reverseQuestionsTitle: "建议在面试反问环节向面试官提问",
    criticalGapsTitle: "亟待补齐的核心短板",
    fitRatings: {
      strong_fit: "强契合 (Strong Fit)",
      workable: "可胜任 (Workable)",
      stretch: "挑战级 (Stretch)",
      gap: "显著差距 (Gap)",
    },
    evaluations: {
  ...
  report: {
    ...
    hiringDecision: {
      ...
      signals: {
        strong_hire: "强烈建议录用 (Strong Hire)",
        hire: "达到录用标准 (Hire)",
        leaning_hire: "弱倾向录用 (Leaning Hire)",
        leaning_no_hire: "倾向不录用 (Leaning No Hire)",
        no_hire: "明确淘汰 (No Hire)",
      },
      rationale: "招委会决策依据",
      keyTradeOffs: "核心权衡取舍",
    },
    innerMonologue: {
      title: "面试官内心真实透视",
      description: "还原考官在关键节点的心理活动与真实潜台词",
      quote: "触发瞬间",
    },
    differentiation: {
      title: "差异化与独到认知",
      levels: {
        template_worker: "模版八股答题者",
        competent_practitioner: "务实执行者",
        differentiated_expert: "独到见解专家",
      },
      earnedSecrets: "独门实战认知 (Earned Secrets)",
    },
    redTeam: {
      title: "红队对抗与盲区审查",
      hiddenAssumptions: "未经验证的底层假设",
      blindSpots: "当局者盲区透视",
      devilsAdvocate: "最致命的淘汰理由 (Devil's Advocate)",
    },
    actionPlan72h: {
      title: "72小时黄金突破行动指南",
      immediate24h: "24h 立即动作",
      storybankAdjust48h: "48h 经历加固",
      targetedDrill72h: "72h 定向演练",
    },
    rewrite: {
      title: "高分重构示范",
      annotations: "精修批注说明",
    ...
    rootCauses: {
      title: "表现根因诊断",
      narrative_hoarding: "叙事囤积 (背景过多)",
      conflict_avoidance: "回避冲突与挫折",
      status_anxiety: "地位焦虑/归因不准",
      surface_framework: "机械套用八股框架",
      story_first_mismatch: "生搬硬套预备故事",
      none: "无明显行为偏差",
    },
    interviewerReactionTitle: "考官即刻心理反应",
    scoreBreakdownTitle: "本题六维得分明细",
    maxScoreLabel: "单项满分 10",
    equalWeightLabel: "等权重计算 (1/6)",
    competencyDesc: "六维综合能力分析（各项均为 0.0 - 10.0 分，由各题单维确定性平均计算）",
    competencyRating: "能力评级",
    detailedAnalysisSubtitle: "深挖每道考题的回答表现、维度得分与考官诊断建议",
    noScorableAnswersText: "无可评分有效回答",
    noAnswerRecordText: "无回答记录",
    recommendationTip: "提示：坚持复盘报告，通常能更快提升下一轮面试表现。",
    recommendationsTitle: "复盘提升建议",
